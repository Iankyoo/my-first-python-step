...
Bem-vindo ao **Sabor Express**! Este é o meu primeiro projeto em Python. Trata-se de uma aplicação de linha de comando (CLI) para gerenciamento de restaurantes.
...
3. Abra o terminal/cmd na pasta do arquivo.
4. Execute o comando:
